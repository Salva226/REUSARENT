<?php
// --- ARCHIVO: scripts_bd/08_crear_tabla_favorito_v2.php ---
...
$sql = "CREATE TABLE favorito (id_favorito INT AUTO_INCREMENT PRIMARY KEY, id_articulo INT, DNI VARCHAR(9)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
$_conexion->query($sql);
echo "Created: " . $_conexion->error;
?>